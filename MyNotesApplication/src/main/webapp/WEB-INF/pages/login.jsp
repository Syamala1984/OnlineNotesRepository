	...
	<div class="container">
		...
		<div style="azimuth: center; vertical-align: middle;">
			<form:form class="form-horizontal" method="post"
				modelAttribute="user" action="login.do">

				<h3>Login</h3>
				<div>
					<div>
						User Name&nbsp; <form:input type="text" ng-model="userName" path="userName" />
					</div>
					<div>
						Password&nbsp; <form:input type="password" ng-model="password" path="password"/>
					</div>
					<div>
